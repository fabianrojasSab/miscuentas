...
//Componente de formulario con las categorias variables
export const FormExpensesVariable = ({ createExpense, expenseToEdit, UpdateExpense }: Props) =>{
...
//Componente de formulario con las categorias fijas pero con el seleccion indicando el mes (no se esta usando en ningun componente)
...
//Componente de formulario con todas las categorias
...
//Componente de formulario con las categorias fijas pero con el campo de fecha
export const FormExpensesFixedInputDate = ({ createExpense, expenseToEdit, UpdateExpense }: Props) =>{
    const [error, setError] = useState<string | null>(null);
    const [expenses, setExpenses] = useState<ExpensesForm | null>(null);
    const [categories, setCategories] = useState<CategoryRow[]>([]);
    const [category, setCategory] = useState("");
